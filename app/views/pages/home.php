 ...
 <!-- SECTION DES POPULAR RECIPES -->
  <section>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <!-- ... SECTION AUTHOR AVEC SES RECIPES ... -->
<section class="bg-gray-700 text-white rounded-lg shadow-2xl p-6 my-6">
          <!-- User Info -->
          <div class="flex items-center mb-6">
            <!-- User Avatar -->
            <img
              src="../documents/pictures/<?php echo $randomUsers['picture']; ?>"
              alt="<?php echo $randomUsers['name']; ?>"
              class="w-24 h-24 rounded-full border-4 border-yellow-500 mr-4"
            />

            <!-- User Details -->
            <div>
              <h3 class="text-2xl font-bold"><?php echo $randomUsers['name']; ?></h3>
              <p class="text-gray-400">Membre depuis: <?php echo $randomUsers['created_at']; ?> </p>
              
              <p class="text-gray-400">Nombre de recettes postées: </p>
            </div>
          </div>
          ...
          <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              <!-- Recipe Card (Repeat for each recipe) -->
               <?php foreach ($randomUsersLatestRecipes as $recipe): ?>
              <article
